...
struct topology
{
   ...
   char
      name[SHS_SIZE], /* model identifyer */
      text[STS_SIZE]; /* any comment */

   long
      n; /* the total number of cells [i.e. nodes] */

# if DSC_ADJCLL == 0 /* <- default; recommended [more economic] usage */
   long
...
/*----------------------------------------------------------------------------*/
/* Maxwell field update parameter structure */
/*............................................................................*/
struct tlmsmx
{ 
   signed char
...
# if DSC_HCRMDE != 0
/*----------------------------------------------------------------------------*/
/* thermal updating parameters structure */
/*............................................................................*/
struct hcrsmx
{ 
   signed char
...
# if DSC_FLDMDE != 0
   ...
   long
      ...
      nuf, /* number of inflow boundary faces */
   ...
   double
      uf[BNDUF][THREE], /* inflow fluid velocity vector [m/s] */
...
/* fluid nodes to be evaluated: */
   ...
   short
      nun[DSC_HCRMDE]; /* number of evaluated velocity nodes */

   long
      mun[DSC_HCRMDE][EVLUN]; /* evaluated velocity mesh cell index, */

   signed char
      cun[DSC_HCRMDE][EVLUN]; /* component index [0:x, 1:y, 2:z], */

   double
      un[DSC_HCRMDE][EVLUN]; /* evaluated velocity component */
# endif /* DSC_FLDMDE != 0 */
/*............................................................................*/
# endif /* DSC_HCRMDE != 0 */
/*............................................................................*/
...
typedef struct
{
   ...
   double
      ic[HCNDS+ONE][FACES], /* heat currents incident over the faces */
      rc[HCNDS+ONE][FACES]; /* truncated and normalized temperature gradients */
                            /* on the faces */
/*............................................................................*/
# if DSC_FLDMDE != 0
   ...
   double /* pressure exchange parameters */
      ip[HCNDS+ONE][FACES], /* pressure on faces */
      rp[HCNDS+ONE][FACES]; /* truncated pressure gradients on the faces */
   ...
   double
      iu[HCNDS+ONE][FACES][THREE], /* fluid flow over the faces */
      ru[HCNDS+ONE][FACES][THREE]; /* truncated and normalized flow gradients */
                                   /* on the faces */
/*............................................................................*/
# if NUSSELT != 0
...
/* compressible flow */
   ...
   double
      ir[HCNDS+ONE][FACES], /* incident density corrections */
      rr[HCNDS+ONE][FACES]; /* truncated density gradients on the faces */
...
# if DSC_FLDMDE != 0
   ...
   FILE
     *tmpstr, /* temperature logfile */
     *prsstr, /* pressure logfile */
     *rsdstr, /* residual logfile */
     *flwstr; /* velocity logfile */

   char
      tmpfle[STS_SIZE], /* temperature log file name */
      prsfle[STS_SIZE], /* pressure log file name */
      rsdfle[STS_SIZE], /* residual log file name */
      flwfle[STS_SIZE]; /* velocity log file name */

   long
      fldnn, /* fluid dynamic iterations counter */
      tmpfp, /* temperature log fle position indicator [returned by ftell(*)] */
      flwfp; /* fluid velocity log file position indicator [ '' ] */
