...
/*----------------------------------------------------------------------------*/
# ifndef USE_NCURSES
   # define USE_NCURSES 0 /* 1: my_terminal window [ BSD, Linux, etc. ] */
# endif
/*----------------------------------------------------------------------------*/
# define DSP_CMODE_   1 /* running cursor implementation [ mode 0,1,2 ] */
/*----------------------------------------------------------------------------*/
...
# define DSP_TRACE_  46 /* ASCII character 32 = ' ' or 46 = '.' */
...
/* 'my_terminal' configuration: */
   ...
   # include <ncurses.h>
   # include <termcap.h>
   # include <term.h> /* terminal type headers */
